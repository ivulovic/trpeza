...
export const demoProducts = [
  ...
  createProduct('Avocado', '5 days', '600 g', 'avocado', 'fruitAndVegetables'),
  createProduct('Apple', '4 days', '1 kg', 'apple', 'fruitAndVegetables'),
  createProduct('Pear', '2 days', '2 kg', 'pear', 'fruitAndVegetables'),
  createProduct('Blueberry', '11 days', '300 g', 'blueberry', 'fruitAndVegetables'),
  createProduct('Watermellon', '2 days', '12 kg', 'watermellon', 'fruitAndVegetables'),
